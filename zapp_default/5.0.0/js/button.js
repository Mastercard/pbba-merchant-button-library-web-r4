	...
	addMethods(
			zapp,
			{
				...
				_init : function() {
					...
					zapp.addJsFile(thisLibUrl + "/js/jsrsasign-latest-all-min.js");
					zapp.addJsFile(thisLibUrl + "/js/appmanifest.js");
			...
			zapp.button.prototype,
			{
				...
				_setupButton : function() {
					...
					var queryString = 'src=' + imageSrc + '&id=' + self.id
							...
							+ zapp.options.showCFILogos + '&appManifestUrl='
							+ zapp.options.appManifestURL;
